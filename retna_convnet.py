...
conv_net = NeuralNet(
    ...
    conv1_num_filters = 64, conv1_filter_size = (3, 3), pool1_ds = (2, 2),
    #dropout1_p = 0.1,
    conv2_num_filters = 128, conv2_filter_size = (3, 3), pool2_ds = (2, 2),
    #dropout2_p = 0.2,
    conv3_num_filters = 256, conv3_filter_size = (3, 3), #pool3_ds = (2, 2),
    #dropout3_p = 0.3,
    conv4_num_filters = 256, conv1_filter_size = (3, 3), pool1_ds = (2, 2),
    #dropout1_p = 0.1,
    conv5_num_filters = 512, conv2_filter_size = (3, 3), #pool2_ds = (2, 2),
    #dropout2_p = 0.2,
